...
std::vector<std::vector<unsigned char> > loadimage::readIDX3UByteFile(const std::string &filename)
{
...
std::vector<std::vector<unsigned char> > loadimage::readLabelFile(const std::string &filename)
{
    std::ifstream file(filename, std::ios::binary);
